...
def makeArgs():
    ...
    parser.add_argument("--ip", "-ip", action="store", help="Endereco ip do servidor")
    parser.add_argument("--port", "-port", default='127.0.0.1', type=int, action="store", help="Porta onde o servidor roda")
